/**
  ...
  *          definitions and memory mapping for CS32F10x Connectivity line, 
...
/* Uncomment the line below according to the target CS32 device used in your
   application 
  */

#if !defined (CS32F10X_LD) && !defined (CS32F10X_LD_VL) && !defined (CS32F10X_MD) && !defined (CS32F10X_MD_VL) && !defined (CS32F10X_HD) && !defined (CS32F10X_HD_VL) && !defined (CS32F10X_XL) && !defined (CS32F10X_CL) 
  /* #define CS32F10X_LD */     /*!< CS32F10X_LD: CS32 Low density devices */
  /* #define CS32F10X_LD_VL */  /*!< CS32F10X_LD_VL: CS32 Low density Value Line devices */  
  /* #define CS32F10X_MD */     /*!< CS32F10X_MD: CS32 Medium density devices */
  /* #define CS32F10X_MD_VL */  /*!< CS32F10X_MD_VL: CS32 Medium density Value Line devices */  
  /* #define CS32F10X_HD */     /*!< CS32F10X_HD: CS32 High density devices */
  /* #define CS32F10X_HD_VL */  /*!< CS32F10X_HD_VL: CS32 High density value line devices */  
  /* #define CS32F10X_XL */     /*!< CS32F10X_XL: CS32 XL-density devices */
  /* #define CS32F10X_CL */     /*!< CS32F10X_CL: CS32 Connectivity line devices */
#endif
/*  Tip: To avoid modifying this file each time you need to switch between these
        devices, you can define the device in your toolchain compiler preprocessor.

 - Low-density devices are CS32F101xx, CS32F102xx and CS32F103xx microcontrollers
   where the Flash memory density ranges between 16 and 32 Kbytes.
 - Low-density value line devices are CS32F100xx microcontrollers where the Flash
   memory density ranges between 16 and 32 Kbytes.
 - Medium-density devices are CS32F101xx, CS32F102xx and CS32F103xx microcontrollers
   where the Flash memory density ranges between 64 and 128 Kbytes.
 - Medium-density value line devices are CS32F100xx microcontrollers where the 
   Flash memory density ranges between 64 and 128 Kbytes.   
 - High-density devices are CS32F101xx and CS32F103xx microcontrollers where
   the Flash memory density ranges between 256 and 512 Kbytes.
 - High-density value line devices are CS32F100xx microcontrollers where the 
   Flash memory density ranges between 256 and 512 Kbytes.   
 - XL-density devices are CS32F101xx and CS32F103xx microcontrollers where
   the Flash memory density ranges between 512 and 1024 Kbytes.
 - Connectivity line devices are CS32F105xx and CS32F107xx microcontrollers.
  */

#if !defined (CS32F10X_LD) && !defined (CS32F10X_LD_VL) && !defined (CS32F10X_MD) && !defined (CS32F10X_MD_VL) && !defined (CS32F10X_HD) && !defined (CS32F10X_HD_VL) && !defined (CS32F10X_XL) && !defined (CS32F10X_CL)
 #error "Please select first the target CS32F10x device used in your application (in CS32f10x.h file)"
#endif
...
/**
 * @brief CS32F10x Standard Peripheral Library version number
   */
#define __CS32F10X_STDPERIPH_VERSION_MAIN   (0x03) /*!< [31:24] main version */                                  
#define __CS32F10X_STDPERIPH_VERSION_SUB1   (0x05) /*!< [23:16] sub1 version */
#define __CS32F10X_STDPERIPH_VERSION_SUB2   (0x00) /*!< [15:8]  sub2 version */
#define __CS32F10X_STDPERIPH_VERSION_RC     (0x00) /*!< [7:0]  release candidate */ 
#define __CS32F10X_STDPERIPH_VERSION       ( (__CS32F10X_STDPERIPH_VERSION_MAIN << 24)\
                                             |(__CS32F10X_STDPERIPH_VERSION_SUB1 << 16)\
                                             |(__CS32F10X_STDPERIPH_VERSION_SUB2 << 8)\
                                             |(__CS32F10X_STDPERIPH_VERSION_RC))
 ...
 */
#ifdef CS32F10X_XL
 #define __MPU_PRESENT             1 /*!< CS32 XL-density devices provide an MPU */
#else
 #define __MPU_PRESENT             0 /*!< Other CS32 devices does not provide an MPU */
#endif /* CS32F10X_XL */
#define __NVIC_PRIO_BITS          4 /*!< CS32 uses 4 Bits for the Priority Levels    */
#define __Vendor_SysTickConfig    0 /*!< Set to 1 if different SysTick Config is used */

/**
 * @brief CS32F10x Interrupt Number Definition, according to the selected device 
...
/******  CS32 specific Interrupt Numbers *********************************************************/
...
/*!< CS32F10x Standard Peripheral Library old types (maintained for legacy purpose) */
typedef int32_t  s32;
typedef int16_t s16;
typedef int8_t  s8;
...
/*!< CS32F10x Standard Peripheral Library old definitions (maintained for legacy purpose) */
...
typedef struct
{
  ...
  __IO uint32_t DOR1;
  __IO uint32_t DOR2;
#if defined (CS32F10X_LD_VL) || defined (CS32F10X_MD_VL) || defined (CS32F10X_HD_VL)
  __IO uint32_t SR;
#endif
} DAC_TypeDef;
...
typedef struct
{
  ...
  uint32_t RESERVED0;
  __IO uint32_t CFGR2;
#endif /* CS32F10X_LD_VL || CS32F10X_MD_VL || CS32F10X_HD_VL */ 
} RCC_TypeDef;
...
#elif defined (CS32F10X_LD_VL) || defined (CS32F10X_MD_VL) || defined (CS32F10X_HD_VL)
 #define  RCC_CFGR_PLLSRC_HSI_Div2           ((uint32_t)0x00000000)        /*!< HSI clock divided by 2 selected as PLL entry clock source */
 #define  RCC_CFGR_PLLSRC_PREDIV1            ((uint32_t)0x00010000)        /*!< PREDIV1 clock selected as PLL entry clock source */
...
#if !defined (CS32F10X_LD) && !defined (CS32F10X_LD_VL)
 #define  RCC_APB2RSTR_IOPERST               ((uint32_t)0x00000040)        /*!< I/O port E reset */
#endif /* CS32F10X_LD && CS32F10X_LD_VL */

#if defined (CS32F10X_HD) || defined (CS32F10X_XL)
...
#if defined (CS32F10X_HD) || defined (CS32F10X_MD) || defined (CS32F10X_LD) || defined  (CS32F10X_XL)
 #define  RCC_APB1RSTR_USBRST                ((uint32_t)0x00800000)        /*!< USB Device reset */
#endif

#if defined (CS32F10X_HD) || defined  (CS32F10X_CL) || defined  (CS32F10X_XL)
...
#if defined (CS32F10X_HD) || defined  (CS32F10X_CL) || defined  (CS32F10X_HD_VL)
...
#if defined (CS32F10X_HD) || defined (CS32F10X_MD) || defined  (CS32F10X_LD)
 #define  RCC_APB1ENR_USBEN                  ((uint32_t)0x00800000)        /*!< USB Device clock enable */
#endif

#if defined (CS32F10X_HD) || defined  (CS32F10X_CL)
